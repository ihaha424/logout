...
protected:
   ...
   void S2C_CamLogicClient(const APawn* Interactor);
   void S2C_CamLogicClient_Implementation(const APawn* Interactor);
...
public:
   ...
   // 숨는 Player
   UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "HideObject", ReplicatedUsing = OnRep_HidePlayer)
