...
#include "EndingConsole.generated.h"

/**
 * 
 */
UCLASS()
class NEW_THEPHANTOMTWINS_API AEndingConsole : public AInteractableObject
{
	GENERATED_BODY()
...
protected:
	...
	UFUNCTION()
	void CheckEndingConditionByPlayerState(class APS_Player* InteractorPlayerState);
...
protected:
	...
	TObjectPtr<class UWidgetComponent> WaitingPlayer3DWidgetComp;
