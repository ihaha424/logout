...
UGA_SmashObstacle::UGA_SmashObstacle()
{
    ...
    AbilityTags.AddTag(FTPTGameplayTags::Get().TPTGamePlayTag_AIAction_SmashObstacle);
    ActivationOwnedTags.AddTag(FTPTGameplayTags::Get().TPTGamePlayTag_AIState_Combat);
}
