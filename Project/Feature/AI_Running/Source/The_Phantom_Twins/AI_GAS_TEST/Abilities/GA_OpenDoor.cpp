...
UGA_OpenDoor::UGA_OpenDoor()
{
    ...
    AbilityTags.AddTag(FTPTGameplayTags::Get().TPTGamePlayTag_AIAction_OpenDoor);
    ActivationOwnedTags.AddTag(FTPTGameplayTags::Get().TPTGamePlayTag_AIState_PerformingAction);
}
